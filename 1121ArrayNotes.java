...
public class ArrayNotes {
    public static void main(String[] args) {
        ...
        */ 
        ...
        // 2. Once that size is set, it can't change (you can't resize an array)
        // 3. Array can only hold one type of data (all ints, all Strings, etc.)
        ...
        int[] temps = new int[7];  // DECLARE the array and set length
                                   // using []
        ...
        */
        ...
        temps[3] = 26;  // no output, just changes a value
        ...
        */
        ...
        // print the last element in THIS array: position 6 (seventh)
    ...
    //Note: If you send an array as a parameter to a method and you change the array inside the method, the changes will "stick" after the method is done
